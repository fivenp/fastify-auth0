...
module.exports = function (fastify, options) {
  ...
  _options.auth0 = {
    ...
    dialogUrl: `https://${_options.domain}/authorize?response_type=code&scope=${_options.scope}&client_id=${_options.client_id}&redirect_uri=${_options.redirect_uri}&state=${_options.state}`
  }
  return _options
}
